{
  description = "A flake for building cosmopolitan";
  ...
  outputs = { self, nixpkgs }: {
    defaultPackage.x86_64-linux =
      ...
      in stdenv.mkDerivation {
        ...
        rm test/libc/calls/fcntl_test.c # https://github.com/NixOS/nix/issues/5674
        rm test/tool/net/redbean_test.c # network acces
